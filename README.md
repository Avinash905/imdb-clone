...
👉[Click here](https://imdb-clone.vercel.app/) to check out the app.

### Description :

IMDb-Clone is an impressive and meticulously designed movie database website built using React, Material-UI, and powered by the TMDB API. It offers users a seamless browsing experience to discover, explore, and engage with a vast collection of movies, TV shows, and celebrities.
...
<img src="./src/assets/categories.png" alt="categories page"/>
